...
- src/app/lore/page.tsx — known (2026-08-17) — the Lore page; Server Component doing the initial fetch, hands data to <LoreSearch />, conditionally renders <LoreCreateForm /> for DMs only, wired up entirely unaided → [[nextjs-routing]] [[nextjs-api-routes]] [[semantic-html]] [[client-components]] [[role-based-rendering]]
- src/app/races/page.tsx — known (2026-08-17) — the Races page; Server Component doing the initial fetch, hands data to <RaceSearch />, conditionally renders <RaceCreateForm /> for DMs only — uses a hardcoded localhost:3000 URL, a known dev-only simplification to fix in Section 9 → [[nextjs-routing]] [[nextjs-link]] [[nextjs-api-routes]] [[http-requests]] [[client-components]] [[role-based-rendering]]
